...
class BaiDaynumber(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'bai_daynumber'


class BaiVisitnumber(models.Model):
    count = models.IntegerField()

    class Meta:
        managed = False
        db_table = 'bai_visitnumber'
...
class TUserip(models.Model):
    ...
    create_times = models.DateTimeField(blank=True, null=True)
